// src/components/public/sections/PublicAbout.tsx
...
export default function PublicAbout() {
  ...
  return (
    <section id="about" className="relative w-full overflow-hidden px-4 py-24 md:px-8 md:py-32 transition-colors duration-700 bg-transparent paper-overlay">
      ...
      <FloatingPetal petalIndex={1} className="top-[10%] left-[5%] w-6 md:w-8" duration={14} delay={0} opacity={0.6} />
      <FloatingPetal petalIndex={2} className="top-[40%] right-[10%] w-5 md:w-6" duration={18} delay={2} opacity={0.6} />
      <FloatingPetal petalIndex={3} className="bottom-[20%] left-[15%] w-7 md:w-10" duration={16} delay={5} opacity={0.6} />
      <FloatingPetal petalIndex={4} className="top-[70%] right-[25%] w-4 md:w-5" duration={20} delay={1} opacity={0.6} />
      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start justify-center relative">
          ...
          <div className="w-full lg:w-[65%] shrink-0 flex items-end relative">
            ...
            <motion.div
              className="absolute -left-12 sm:-left-20 -bottom-8 sm:-bottom-12 z-20 w-32 h-32 sm:w-48 sm:h-48 pointer-events-none"
            ...
            <motion.div
              className="hidden lg:block absolute -right-16 sm:-right-[19rem] -bottom-16 sm:bottom-5 z-30 pointer-events-none"
                ...
                <div className="relative z-10 ml-4">
                  ...
                  <div className="prose max-w-none font-body text-[13px] leading-6 text-charcoal/80 dark:text-[#EAE0D5]/80 md:text-sm md:leading-7 [&_p]:mb-6 [&_p:last-child]:mb-0 [&_p]:break-words">
                    ...
                    <div className="md:hidden relative border-y border-charcoal/10 dark:border-white/10 shadow-[inset_0_-10px_10px_-10px_rgba(0,0,0,0.05)] mb-6">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 flex justify-center pb-2 pointer-events-none text-charcoal/60 dark:text-[#EAE0D5]/60 bg-gradient-to-t from-[#FDFBF7] dark:from-[#22201F] to-transparent pt-8">
                        <span className="text-[10px] font-bold tracking-widest animate-bounce">SCROLL ▼</span>
                      </div>
                    </div>
                  </div>
                </div>
