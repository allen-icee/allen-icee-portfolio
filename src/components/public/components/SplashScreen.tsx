    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <motion.div
            className="relative flex items-center justify-center w-48 h-48 sm:w-64 sm:h-64 rounded-full bg-[#111] dark:bg-black shadow-[0_0_50px_rgba(107,76,154,0.1),inset_0_0_10px_rgba(255,255,255,0.05)] border border-white/10"
