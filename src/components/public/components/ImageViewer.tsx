...
interface ImageViewerProps {
  ...
  altText?: string;
  onClose: () => void;
  renderSidePanel?: (index: number) => React.ReactNode;
}
...
export default function ImageViewer({ images, initialIndex = 0, altText = "Image viewer", onClose, renderSidePanel }: ImageViewerProps) {
  ...
  return (
    <div 
      className="fixed inset-0 z-[100] bg-[#0F0D12]/90 backdrop-blur-md flex flex-col lg:flex-row animate-in fade-in duration-200"
      role="dialog"
      aria-modal="true"
      onClick={(e) => {
    ...
    >
      ...
      <button
        type="button"
        onClick={onClose}
        className="absolute right-6 top-6 z-[110] grid size-12 place-items-center rounded-full bg-black/20 text-white backdrop-blur transition hover:bg-purple-brand hover:scale-110 focus:outline-none focus:ring-2 focus:ring-white/50"
      ...
      {images.length > 1 && (
        <>
          <button
            ...
            className="absolute left-6 top-1/2 z-[110] -translate-y-1/2 grid size-12 place-items-center rounded-full bg-black/20 text-white backdrop-blur transition hover:bg-purple-brand hover:scale-110 focus:outline-none focus:ring-2 focus:ring-white/50"
          ...
          <button
            ...
            className="absolute right-6 top-1/2 z-[110] -translate-y-1/2 grid size-12 place-items-center rounded-full bg-black/20 text-white backdrop-blur transition hover:bg-purple-brand hover:scale-110 focus:outline-none focus:ring-2 focus:ring-white/50"
      ...
      >
        <button
          ...
          className="grid size-10 place-items-center rounded-full text-white transition hover:bg-purple-brand hover:scale-110 disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:scale-100 focus:outline-none focus:ring-2 focus:ring-white/50"
          aria-label="Zoom out"
        >
