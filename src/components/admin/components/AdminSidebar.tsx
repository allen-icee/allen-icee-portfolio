...
const links = [
  ...
  { to: '/admin/journal', label: 'Journal', icon: 'lucide:book-open' },
  ...
  { to: '/admin/media', label: 'Media', icon: 'lucide:image' },
]
  ...
  return (
    <aside className="flex h-full flex-col">
      <div className="border-b border-white/[0.06] px-5 py-5">
        <p className="text-sm font-medium text-white/80">Library CMS</p>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition-colors ${
                isActive
                  ? 'bg-purple-brand/20 text-purple-brand/90'
